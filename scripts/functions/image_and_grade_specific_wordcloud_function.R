...
# function for wordclouds, ordered by grades AND images
...
# function for wordclouds, ordered by image only
meko_wordcloud_by_image <- function(unit, task, split_path, max_words, excluded_words = NULL, output_dir){
  ...
  # now create worldclouds
  if(is.null(unlist(Bild_1))==F){draw_the_clouds(Bild_1, file.path(output_dir, paste0("wordcloud_Bild1.png")))}
  if(is.null(unlist(Bild_2))==F){draw_the_clouds(Bild_2, file.path(output_dir, paste0("wordcloud_Bild2.png")))}
  if(is.null(unlist(Bild_3))==F){draw_the_clouds(Bild_3, file.path(output_dir, paste0("wordcloud_Bild3.png")))}
  if(is.null(unlist(Bildreihe_1))==F){draw_the_clouds(Bildreihe_1, file.path(output_dir, paste0("wordcloud_Bildreihe1.png")))}
  if(is.null(unlist(Bildreihe_2))==F){draw_the_clouds(Bildreihe_2, file.path(output_dir, paste0("wordcloud_Bildreihe2.png")))}
  if(is.null(unlist(Bildreihe_3))==F){draw_the_clouds(Bildreihe_3, file.path(output_dir, paste0("wordcloud_Bildreihe3.png")))}
}