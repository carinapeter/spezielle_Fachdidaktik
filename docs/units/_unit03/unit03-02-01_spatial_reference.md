...
* Referenzrahmen: Das durch das geodätische Datum aufgespannte Koordinatensystem wird an der Erdoberfläche über die Koordinaten von sogenannten Festpunkten in einen Referenzrahmen eingehängt. Im Minimalfall ist ein Festpunkte notwendig. Bei hochgenauen Vermessungen muss ferner die Abweichung zwischen der Lotrichtung, die durch das Schwerefeld der Erde bestimmt ist und der Normalen auf den Referenzellipsoid berücksichtigt werden.
