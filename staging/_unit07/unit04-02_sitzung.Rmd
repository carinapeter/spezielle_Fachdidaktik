...
```{r zones, echo=TRUE, message=FALSE, warning=FALSE, out.width="800px", results=TRUE}
...
```{r zone_result, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE,out.width = "1000px",out.height = "550px",fig.retina = 1}
...
```{r lorenz, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE, out.width = "400px",out.height = "400px",fig.retina = 1}
...
```{r zone_raster, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
...
```{r plot_zone_raster, echo=TRUE, message=FALSE, warning=FALSE, results=FALSE,out.width = "1100px",out.height = "900px",fig.retina = 1}
# Festlegen der Grafik-Ausgabe
...
```{r zone_hist, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE,fig.retina = 1}
...
```{r points_0, echo=TRUE, message=FALSE, warning=FALSE, results=FALSE,out.width = "800px",out.height = "600px",fig.retina = 1}
...
```{r points-2, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE,out.width = "800px",out.height = "600px",fig.retina = 1}
...
```{r r-train-2, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r point_dist, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
...
```{r matrix, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
...
```{r table_2, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
...
```{r matrix_operand, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
# Distanzmatrix für Entfernungen > 250 km
cd = city_distanz  < 250000
```

```{r table_3, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
...
```{r weight, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
# inverse Distanz
gewichtungs_matrix =  (1 / city_distanz)

```
```{r invdist, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
# inverse Distanz zum Quadrat
gewichtungs_matrix_q =  (1 / city_distanz ** 2)

```

```{r table_4, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
# Ausgabe einer hübscheren Tabelle mit kintr::kable die Notation ist das sogenannte pipen aus der tidyverse Welt
...
```{r linnorm, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
...
```{r binary_ngb, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE,out.width = "1000px",out.height = "1000px",fig.retina = 1}
...
```{r neareast_ngb, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE,out.height = "1000px",fig.retina = 1}
...
```{r distanz-ngb, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE,fig.retina = 1}
...
```{r moran_setup, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE,fig.retina = 1}
...
```{r moran, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
nuts3_kreise_rook = poly2nb(nuts3_kreise, row.names=nuts3_kreise$NUTS_NAME, queen=FALSE)
...
```{r residuen, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE}
...
```{r moran_plot, echo=TRUE, message=FALSE, warning=FALSE, results=TRUE,out.width = "800px",out.height = "800px",fig.retina = 1}
